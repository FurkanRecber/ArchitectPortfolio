...
export interface Message {
    ...
    content: string;
    status: string;
    email?: string; // Optional for reply function
}
                                ...
                                <div className="border-t border-zinc-100 dark:border-[#1F2430] pt-6 mb-6">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-zinc-400 hover:text-red-600 dark:hover:text-red-400 transition-colors" title="Delete">
                                                <Trash2 size={18} />
                                            </button>
                                        </div>
                                    </div>
