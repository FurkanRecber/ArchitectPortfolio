        ...
        <div className="flex-1 overflow-y-auto p-8 h-full">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">All Projects</h3>
                    <span className="px-2 py-0.5 bg-zinc-200 dark:bg-[#1F2430] text-zinc-600 dark:text-slate-400 text-xs rounded-full font-medium">{projects.length} Total</span>
                </div>
                <button
            ...
            <div className="bg-white dark:bg-[#151922] border border-zinc-200 dark:border-[#1F2430] rounded-xl overflow-hidden shadow-sm">
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-zinc-200 dark:divide-[#1F2430]">
                        ...
                        {projects.length === 0 && (
                            <tr>
                                <td colSpan={5} className="text-center py-10 text-zinc-500">Henüz hiç proje yok.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
